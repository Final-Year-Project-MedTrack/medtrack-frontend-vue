<template>
  <div class="p-6 bg-white ">
    <div class="flex justify-between items-center mb-4">
      ...
      <router-link :to="{name: 'MedicalProviderDashboardRecordPatientVitals', params:{'patientId':visit.patient.id}}" class="bg-gray-700 text-white px-4 py-2 rounded hover:bg-gray-800">
        + Record Vital
      </router-link>
    </div>
